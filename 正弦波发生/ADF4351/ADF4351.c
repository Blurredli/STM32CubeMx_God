...
// ADF 输入 GPIO 初始化 (PC9/PC11/PC12 输出, PC10 浮空输入)
void ADF_Input_GPIOInit(void)
{
    ...
    GPIO_InitStruct.Pull = GPIO_NOPULL;  // HAL里没有“IN_FLOATING”，用NOPULL等效
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
}
